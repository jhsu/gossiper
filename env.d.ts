...
export type CoercedEnvSchema = {
  ...
  /**
   * **SLACK_CLIENT_SECRET** 🔐 _sensitive_  
   * ![icon](data:image/svg+xml;utf-8,%3Csvg%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%20width%3D%2220%22%20height%3D%2220%22%20viewBox%3D%220%200%2032%2032%22%3E%3Cpath%20fill%3D%22%23808080%22%20d%3D%22M29%2022h-5a2.003%202.003%200%200%201-2-2v-6a2%202%200%200%201%202-2h5v2h-5v6h5ZM18%2012h-4V8h-2v14h6a2.003%202.003%200%200%200%202-2v-6a2%202%200%200%200-2-2m-4%208v-6h4v6Zm-6-8H3v2h5v2H4a2%202%200%200%200-2%202v2a2%202%200%200%200%202%202h6v-8a2%202%200%200%200-2-2m0%208H4v-2h4Z%22%2F%3E%3C%2Fsvg%3E)   
   */
  SLACK_CLIENT_SECRET: string;
  
  /**
   * **SLACK_SIGNING_SECRET** 🔐 _sensitive_  
   * ![icon](data:image/svg+xml;utf-8,%3Csvg%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%20width%3D%2220%22%20height%3D%2220%22%20viewBox%3D%220%200%2032%2032%22%3E%3Cpath%20fill%3D%22%23808080%22%20d%3D%22M29%2022h-5a2.003%202.003%200%200%201-2-2v-6a2%202%200%200%201%202-2h5v2h-5v6h5ZM18%2012h-4V8h-2v14h6a2.003%202.003%200%200%200%202-2v-6a2%202%200%200%200-2-2m-4%208v-6h4v6Zm-6-8H3v2h5v2H4a2%202%200%200%200-2%202v2a2%202%200%200%200%202%202h6v-8a2%202%200%200%200-2-2m0%208H4v-2h4Z%22%2F%3E%3C%2Fsvg%3E)   
   */
  ...
  /**
   * **GOSSIP_PROBABILITY**  
   * Optional override if different from PUBLIC_BASE_URL + /slack/oauth/callback  
   * SLACK_REDIRECT_URI=https://your-domain.example/slack/oauth/callback  
   * Optional: limit the bot to one channel in every workspace  
   * SLACK_CHANNEL_ID=C0123456789  
   * Optional: change SQLite file location  
   * DATABASE_PATH=./slack-side-voice.sqlite  
   *   
   * team=T04TJ6PCXB9 channel=C0ALLRMFQLE user=U088NPR8M5F  
   * SLACK_CHANNEL_WHITELIST=C0ALLRMFQLE  
   * Comma-separated user IDs to send gossip messages to  
   * SLACK_USER_WHITELIST=U088NPR8M5F  
...
declare module 'varlock/env' {
  ...
  export interface PublicTypedEnvSchema extends Readonly<Pick<CoercedEnvSchema, 'SLACK_CLIENT_ID' | 'OPENAI_MODEL' | 'TURSO_DATABASE_URL' | 'PORT' | 'PUBLIC_BASE_URL' | 'GOSSIP_PROBABILITY'>> {}
}
